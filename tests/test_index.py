...
from Flask_App import app, utils
...
#
#
# @patch('Flask_App.utils.load_products')
# @patch('Flask_App.utils.load_all_products')
# @patch('Flask_App.utils.get_cate_by_id')
# @patch('Flask_App.utils.count_product')
# @patch('Flask_App.utils.load_all_brands')
# def test_home(mock_load_all_brands, mock_count_product, mock_get_cate_by_id,
#               mock_load_all_products, mock_load_products, client):
#     # Mock dữ liệu
#     mock_load_products.return_value = [
#         {'id': 1, 'name': 'Product 1', 'price': 1000.0},
#         {'id': 2, 'name': 'Product 2', 'price': 2000.0}
#     ]
#     mock_load_all_products.return_value = [
#         {'id': 1, 'name': 'All Product 1'},
#         {'id': 2, 'name': 'All Product 2'},
#         {'id': 3, 'name': 'All Product 3'}
#     ]
#     mock_get_cate_by_id.return_value = [
#         {'id': 1, 'name': 'Điện Thoại'}
#     ]
#     mock_count_product.return_value = 10
#     mock_load_all_brands.return_value = [
#         {'id': 1, 'name': 'Brand 1'},
#         {'id': 2, 'name': 'Brand 2'}
#     ]
#
#     # Gửi request
#     response = client.get('/product?page=1&category_id=1&kw=laptop')
#
#     # Kiểm tra status code
#     assert response.status_code == 200
#
#     # Kiểm tra các dữ liệu trong response
#     html = response.data.decode('utf-8')
#     assert 'Product 1' in html
#     assert 'Product 2' in html
#     assert 'Electronics' in html
#     assert 'Brand 1' in html
#     assert 'Brand 2' in html
#
#
